            ...
            Center(
              child: CustomButton(
                ...
                onTap: () {
                  ...
                  List<String> selectedUseCases = selectedIndices.map((index) {
                    return goals[index]['text']!.toUpperCase().replaceAll(' ', '_').replaceAll('-', '_');
                  }).toList();
                  
                  onboardingController.updateData('useCases', selectedUseCases);
