...
class Onlading13 extends StatefulWidget {
  ...
  @override
  State<Onlading13> createState() => _Onlading13State();
}

class _Onlading13State extends State<Onlading13> {
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const OnboardingHeader(currentPage: 12),
            ...
            Text(
              "Even the small wins count. We see you.",
              textAlign: TextAlign.start,
              style: AppTextStyles.plusJakartaSans(
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText: "Something big or small that made you proud...",
