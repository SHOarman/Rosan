...
class Onlading11 extends StatefulWidget {
  ...
  @override
  State<Onlading11> createState() => _Onlading11State();
}
...
class _Onlading11State extends State<Onlading11> {
  ...
  Widget build(BuildContext context) {
    final List<Map<String, String>> reminders = [
      {"text": "Just once a day", "emoji": "🌅"},
      {"text": "A few gentle nudges", "emoji": "🔔"},
      {"text": "Smart — only when needed", "emoji": "🧠"},
      {"text": "Frequent check-ins", "emoji": "📲"},
    ];
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const OnboardingHeader(currentPage: 10),
            ...
            Text(
              "We'll keep you on track without overwhelming you.",
              textAlign: TextAlign.start,
              style: AppTextStyles.plusJakartaSans(
...
class _ReminderPillCardState extends State<ReminderPillCard> with SingleTickerProviderStateMixin {
