...
class CustomBottomNavBar extends StatelessWidget {
  ...
  // Uses the device's real vibration motor instead of relying on the OS
  // "touch feedback" haptic setting, so it works consistently across
  // devices where HapticFeedback.lightImpact() alone was inconsistent.
