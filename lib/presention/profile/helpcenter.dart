...
class HelpCenter extends StatelessWidget {
  ...
  final RxInt _expandedIndex = 0.obs;
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      final faqsList = _supportController.faqs;
      final filteredFaqs = faqsList.where((faq) {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // FAQs List
                _supportController.isLoading.value
                    ? const Center(
                  child: Padding(
                    padding: EdgeInsets.all(20.0),
                    child: CircularProgressIndicator(color: Color(0xFF7B64B0)),
                  ),
                )
                    : ListView.separated(
                  shrinkWrap: true,
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final originalIndex = faqsList.indexOf(faq);
                    final isExpanded = _expandedIndex.value == originalIndex;
                        ...
                        child: Theme(
                          ...
                          child: ExpansionTile(
                            ...
                            onExpansionChanged: (expanded) {
                              _expandedIndex.value = expanded ? originalIndex : -1;
                            },
                            title: Text(
                              faq["question"]!,
                              style: AppTextStyles.inter(
