...
class _PrivacyPolicyPageState extends State<PrivacyPolicyPage> {
  ...
  void initState() {
    super.initState();
    _supportController.fetchPrivacy();
  }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Obx(() {
                if (_supportController.isPrivacyLoading.value) {
                  return const Center(
                    child: Padding(
                ...
                if (_supportController.privacyPolicies.isEmpty) {
                  return Center(
                    child: Padding(
                      padding: const EdgeInsets.all(40.0),
                      child: Text(
                        "No privacy policy details found.",
                        style: AppTextStyles.inter(
                          fontSize: 14,
                          fontWeight: FontWeight.w500,
                          color: const Color(0xFF575B61),
                ...
                return ListView.separated(
                  ...
                  shrinkWrap: true,
                  itemCount: _supportController.privacyPolicies.length,
                  separatorBuilder: (context, index) => const SizedBox(height: 16.0),
                  itemBuilder: (context, index) {
                    final policy = _supportController.privacyPolicies[index];
